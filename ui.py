...
#         print(f"- {model}")
# else:
#     print("Could not retrieve the list of Gemini models.")
...
def setup_sidebar():
    ...
    with st.sidebar:
        ...
        <div style="text-align: center; margin-top: 20px;">
            <p>🚀 Recruiter Recruitment Agent</p>
...
"""
        ...
        href = f'<a class="download-btn" href="data:text/plain;base64,{report_b64}" download="Recruiter_resume_analysis.txt">📊 Download Analysis Report</a>'
        ...
        if generate_questions_func:
            with st.spinner("Generating personalized interview questions..."):
                ...
                if questions:
                    ...
                    href = f'<a class="download-btn" href="data:text/markdown;base64,{b64}" download="Recruiter_interview_questions.md">📝 Download All Questions</a>'
                    st.markdown(href, unsafe_allow_html=True)
    ...
    if st.button("Generate Resume Improvements"):
        if improve_resume_func:
            with st.spinner("Analyzing and generating improvements..."):
                ...
                href = f'<a class="download-btn" href="data:text/markdown;base64,{b64}" download="Recruiter_resume_improvements.md">📝 Download All Suggestions</a>'
                st.markdown(href, unsafe_allow_html=True)
        ...
        if get_improved_resume_func:
            with st.spinner("Creating improved resume..."):
                ...
                with col1:
                    ...
                    href = f'<a class="download-btn" href="data:file/txt;base64,{b64}" download="Recruiter_improved_resume.txt">📄 Download as TXT</a>'
                    st.markdown(href, unsafe_allow_html=True)
...
"""
                    ...
                    md_href = f'<a class="download-btn" href="data:text/markdown;base64,{md_b64}" download="Recruiter_improved_resume.md">📝 Download as Markdown</a>'
